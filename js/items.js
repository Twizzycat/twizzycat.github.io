...
$(document).ready(function () {
  ...
  $('#item-2-youtube').dblclick(function () {
    window.open('https://www.last.fm/de/user/flockyflocky');
  });


  $('#item-2-discord').dblclick(function () {
    window.open('https://discord.com/invite/qVHQrxGr6R');
  });


  $('#item-2-spotify').dblclick(function () {
    window.open('https://open.spotify.com/user/31bn74qsjrxaxwujq5yev62ualue?si=cd102d658fed4d53');
  });
